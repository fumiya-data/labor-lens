...
Style: staged waterfall with feedback checkpoints
...
| 文書 | 主な参照元 | 主な参照先 |
| --- | --- | --- |
| [`REQUIREMENTS.md`](REQUIREMENTS.md) | [`USE-CASES.md`](USE-CASES.md) | `GLOSSARY.md`, `BUSINESS-RULES.md`, `ACCEPTANCE-CRITERIA.md`, `LEAN-SPEC-PLANNING.md` |
| [`GLOSSARY.md`](GLOSSARY.md) | `REQUIREMENTS.md` | `BUSINESS-RULES.md`, `DATA-DESIGN.md`, `LEAN-SPEC-PLANNING.md` |
| [`BUSINESS-RULES.md`](BUSINESS-RULES.md) | `REQUIREMENTS.md`, `GLOSSARY.md` | `ACCEPTANCE-CRITERIA.md`, `DATA-DESIGN.md`, `TEST-PLAN.md` |
| [`ACCEPTANCE-CRITERIA.md`](ACCEPTANCE-CRITERIA.md) | `REQUIREMENTS.md`, `BUSINESS-RULES.md` | `TEST-PLAN.md`, `VERIFICATION-REPORT.md` |
| [`EXTERNAL-DESIGN.md`](EXTERNAL-DESIGN.md) | `REQUIREMENTS.md`, `GLOSSARY.md` | `DATA-DESIGN.md`, `ARCHITECTURE.md`, `TEST-PLAN.md` |
| [`DATA-DESIGN.md`](DATA-DESIGN.md) | `REQUIREMENTS.md`, `GLOSSARY.md`, `BUSINESS-RULES.md` | `ARCHITECTURE.md`, `DETAILED-DESIGN.md`, `TEST-PLAN.md`, `LEAN-SPEC-PLANNING.md` |
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | `REPOSITORY-PLAN.md`, `DATA-DESIGN.md`, `REQUIREMENTS.md` | `DETAILED-DESIGN.md`, `IMPLEMENTATION-PLAN.md`, `OPERATIONS.md` |
...
| [`TEST-PLAN.md`](TEST-PLAN.md) | `ACCEPTANCE-CRITERIA.md`, `BUSINESS-RULES.md`, `DETAILED-DESIGN.md` | `VERIFICATION-REPORT.md` |
...
| [`OPERATIONS.md`](OPERATIONS.md) | `ARCHITECTURE.md`, `VERIFICATION-REPORT.md`, `REQUIREMENTS.md` | 運用手順、障害対応、保守計画 |
...
3. [`ACCEPTANCE-CRITERIA.md`](ACCEPTANCE-CRITERIA.md)
